...
@app.route('/syllabus/cheat_sheet', methods=["GET"])
...
def edit_content(content_path, TOC: TableOfContent):
    ...
    if request.method == "POST":
        ...
        return render_template("edit_page.html", content_data=get_content_data(content), cheat_sheet=get_cheat_sheet(), content=content, TOC=TOC)
